...
class WelcomeViewController: UIViewController {
    ...
    func animateBackgroundColor() {
        colorArray.append((color1: #colorLiteral(red: 0.9372969866, green: 0.7266486287, blue: 0.8501775861, alpha: 1), color2: #colorLiteral(red: 0.5882352941, green: 0.8509803922, blue: 0.8901960784, alpha: 1)))
        ...
        UIView.transition(with: gradientView, duration: 3, options: [.transitionCrossDissolve], animations: {
            ...
            UIView.transition(with: self.winnerLabel, duration: 0.5, options: [.transitionCrossDissolve], animations: {
                ...
                if self.colorArray[self.currentColorIndex].color1 == #colorLiteral(red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1) || self.colorArray[self.currentColorIndex].color1 == #colorLiteral(red: 0.3098039329, green: 0.01568627544, blue: 0.1294117719, alpha: 1){
